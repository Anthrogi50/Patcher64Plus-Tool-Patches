function ByteOptions() {
    ...
    if (IsIndex -Elem $Redux.Hero.MonsterHP -Index 3 -Not) {
        ...
        MultiplyBytes -Offset @("1BBC7C4", "1BC337C", "1C8CB8C", "1BC3C1F", "1C66327", "1C677FB", "1D349DF") -Factor $multi -Max 127 # Regular/Composer Poe, Wallmaster, Floormaster/Fragmaster, Dodongo, Blue & Red Bubble, Like-Like
        MultiplyBytes -Offset @("1BDC69B", "1BDC70F")                                                        -Factor $multi -Max 127 # Red & Blue Tektite
        MultiplyBytes -Offset @("1BDF4E7", "1BDF57B")                                                        -Factor $multi -Max 127 # Regular & Purple Leever
        MultiplyBytes -Offset @("1BE1167", "1C19353")                                                        -Factor $multi -Max 127 # Peahat, Torch Slug
        MultiplyBytes -Offset @("1C0611B", "1C18D8C", "1C1E0AC", "1D038CB", "1D4D03B")                       -Factor $multi -Max 127 # Gohma Larva, Skulltula, Stinger, Shellblade, Spike Ball
        MultiplyBytes -Offset @("1C141AC", "1C5EFFC")                                                        -Factor $multi -Max 127 # Biri, Bari
        MultiplyBytes -Offset @("1C14777", "1C9DC64")                                                        -Factor $multi -Max 127 # Tailpasaran, Regular/Gold Walltula
        MultiplyBytes -Offset @("1C7D103", "1C7D107")                                                        -Factor $multi -Max 127 # Big & Regular Beamos
        MultiplyBytes -Offset "1C8E667"                                                                      -Factor $multi -Max 127 # ReDead/Gibdo
    }
    ...
    if (IsIndex -Elem $Redux.Hero.MiniBossHP -Index 3 -Not) {
        ...
        MultiplyBytes -Offset @("1BA74E3", "1C9566C") -Factor $multi -Max 127 # Stalfos, Poe Sisters
        MultiplyBytes -Offset @("1BEBE2F", "1BEBE3B") -Factor $multi -Max 127 # Lizalfos, Dinolfos
        MultiplyBytes -Offset @("1CAABE7", "1EB7083") -Factor $multi -Max 127 # Flare Dancer, Wolfos
        MultiplyBytes -Offset "1CC26FB"               -Factor $multi -Max 127 # Dead Hand
    ...
    if (IsIndex -Elem $Redux.Hero.BossHP -Index 3 -Not) {
        ...
        MultiplyBytes -Offset "1BF9057"               -Factor $multi -Max 127        # Queen Gohma
        ...
        MultiplyBytes -Offset "1E6A57B"               -Factor $multi -Min 3 -Max 127 # Ganondorf (Demon)
    }
    ...
    if (IsChecked $Redux.Enemy.QueenGohma)  { ChangeBytes -Offset @("1BF9412", "1BF9416", "1BFC222") -Values "0000"; ChangeBytes -Offset "1BF96CA" -Values "0016"; ChangeBytes -Offset "1BFC3E6" -Values "0030"; ChangeBytes -Offset "1BFD46E" -Values "0020"; ChangeBytes -Offset "1BFD48E" -Values "000C"; ChangeBytes -Offset "1BFC7F8" -Values "00000000"; ChangeBytes -Offset "1BFCBCA" -Values "1000"; ChangeBytes -Offset "36B0469" -Values "03" }
...
function CreateTabDifficulty() {
    ...
    CreateReduxComboBox -Name "MagicUsage1"    -Text "All Magic Usage" -Default 1 -Items @("1x Magic Usage", "2x Magic Usage", "4x Magic Usage", "8x Magic Usage") -Info "Set the multiplier rate the magic is consumed at, for all instances."                    -Credits "Admentus & Anthrogi (ported)"
    CreateReduxCheckBox -Name "NoBottledFairy" -Text "No Bottled Fairies"                                                                                          -Info "Fairies can no longer be bottled, you'll have to buy them to store them."                -Credits "Admentus & Anthrogi (ported)"
    ...
    CreateReduxCheckBox -Name "QueenGohma"  -Text "Queen Gohma"       -Info "Queen Gohma recovers faster from being stunned, lays 3 eggs at once and attacks more efficiently."                                                                                                                                                                   -Credits "Euler & Anthrogi (also ported)"
    ...
    CreateReduxTextBox -Name "Heart"       -Text "Heart"             -Value 16  -Min 1 -Max 320 -Length 3 -Info "Set the amount of health that Hearts will restore."                             -Credits "Admentus, Three Pendants & Anthrogi (ported)"
    CreateReduxTextBox -Name "Fairy"       -Text "Fairy"             -Value 128 -Min 1 -Max 320 -Length 3 -Info "Set the amount of health that a Fairy will restore."                            -Credits "Admentus & Anthrogi (ported)"
    ...
    CreateReduxTextBox -Name "RedPotion"   -Text "Red Potion"        -Value 320 -Min 1 -Max 320 -Length 3 -Info "Set the amount of health that a Red Potion will restore."                       -Credits "Admentus, Three Pendants & Anthrogi (ported)"
    ...
    CreateReduxTextBox  -Name "LightArrow"  -Text "Light Arrow"       -Value 8  -Min 2 -Max 96                                                                    -Info "Set the magic cost for using Light Arrows.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter."  -Credits "Admentus & Anthrogi (ported)"
    ...
    CreateReduxTextBox  -Name "Teleport"    -Text "Farore's Wind"     -Value 12 -Min 2 -Max 96                                                                    -Info "Set the magic cost for using Farore's Wind.`n48 is the maximum amount of the standard magic meter while 96 is the maximum amount of the double magic meter." -Credits "Admentus & Anthrogi (ported)"
...
function CreateTabColors() {
    ...
    $Redux.Colors.Equipment += CreateReduxComboBox -Name "KokiriTunic"         -Text "Kokiri Tunic"     -Default 1 -Length 230 -Items $items1 -PostItems $postItems -FilePath $Files -Info ("Select a color scheme for the Kokiri Tunic.`n" + $Randomize) -Credits "Randomizer & Anthrogi (ported)"
    $Buttons += CreateReduxButton -Tag $Buttons.Count -Text "Kokiri Tunic"     -Info "Select the color you want for the Kokiri Tunic."                                                                                                                    -Credits "Randomizer & Anthrogi (ported)"
    $Redux.Colors.Equipment += CreateReduxComboBox -Name "GoronTunic"          -Text "Goron Tunic"      -Default 2 -Length 230 -Items $items1 -PostItems $postItems -FilePath $Files -Info ("Select a color scheme for the Goron Tunic.`n"  + $Randomize) -Credits "Randomizer & Anthrogi (ported)"
    $Buttons += CreateReduxButton -Tag $Buttons.Count -Text "Goron Tunic"      -Info "Select the color you want for the Goron Tunic."                                                                                                                     -Credits "Randomizer & Anthrogi (ported)"
    $Redux.Colors.Equipment += CreateReduxComboBox -Name "ZoraTunic"           -Text "Zora Tunic"       -Default 3 -Length 230 -Items $items1 -PostItems $postItems -FilePath $Files -Info ("Select a color scheme for the Zora Tunic.`n"  + $Randomize)  -Credits "Randomizer & Anthrogi (ported)"
    $Buttons += CreateReduxButton -Tag $Buttons.Count -Text "Zora Tunic"       -Info "Select the color you want for the Zora Tunic."                                                                                                                      -Credits "Randomizer & Anthrogi (ported)"
    $Redux.Colors.Equipment += CreateReduxComboBox -Name "SilverGauntlets"     -Text "Silver Gauntlets" -Default 1 -Length 230 -Items $Items2 -Info ("Select a color scheme for the Silver Gauntlets.`n" + $Randomize)                                    -Credits "Randomizer & Anthrogi (ported)"
    $Buttons += CreateReduxButton -Tag $Buttons.Count -Text "Silver Gaunlets"  -Info "Select the color you want for the Silver Gauntlets."                                                                                                                -Credits "Randomizer & Anthrogi (ported)"
    $Redux.Colors.Equipment += CreateReduxComboBox -Name "GoldenGauntlets"     -Text "Golden Gauntlets" -Default 2 -Length 230 -Items $Items2 -Info ("Select a color scheme for the Golden Gauntlets.`n" + $Randomize)                                    -Credits "Randomizer & Anthrogi (ported)"
    $Buttons += CreateReduxButton -Tag $Buttons.Count -Text "Golden Gauntlets" -Info "Select the color you want for the Golden Gauntlets."                                                                                                                -Credits "Randomizer & Anthrogi (ported)"
...
function CreateTabQuantity() {
    ...
    CreateReduxTextBox -Name "DekuStick"    -Text "Deku Sticks"     -Value 1  -Min 1 -Max 30 -Info "Set the amount gained for picking up a Deku Stick."       -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "DekuNut_Bomb" -Text "Deku_Nuts/Bombs" -Value 5  -Min 1 -Max 40 -Info "Set the amount gained for picking up Deku Nuts or Bombs." -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "DekuSeed"     -Text "Deku Seeds"      -Value 5  -Min 1 -Max 50 -Info "Set the amount gained for picking up Deku Seed Bullets."  -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Arrow1"       -Text "Arrows 1"        -Value 5  -Min 1 -Max 50 -Info "Set the amount gained for picking up Single Arrows."      -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Arrow2"       -Text "Arrows 2"        -Value 10 -Min 1 -Max 50 -Info "Set the amount gained for picking up Double Arrows."      -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Arrow3"       -Text "Arrows 3"        -Value 30 -Min 1 -Max 50 -Info "Set the amount gained for picking up Triple Arrows."      -Credits "Admentus & Anthrogi (ported)"

    # MONEY #

    CreateReduxGroup   -Tag  "Currency"         -Text "Money"
    CreateReduxTextBox -Name "Rupee1" -Length 3 -Text "Green Rupee"       -Value 1   -Min 1 -Max 500 -Info "Set the amount gained for picking up Green Rupees."          -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Rupee2" -Length 3 -Text "Blue Rupee"        -Value 3   -Min 1 -Max 500 -Info "Set the amount gained for picking up Blue Rupees."           -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Rupee3" -Length 3 -Text "Red Rupee"         -Value 15  -Min 1 -Max 500 -Info "Set the amount gained for picking up Red Rupees."            -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Rupee4" -Length 3 -Text "Purple Rupee"      -Value 50  -Min 1 -Max 500 -Info "Set the amount gained for picking up Purple Rupees."         -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Rupee5" -Length 3 -Text "Orange/Gold Rupee" -Value 200 -Min 1 -Max 500 -Info "Set the amount gained for picking up Orange or Gold Rupees." -Credits "Admentus & Anthrogi (ported)"
    CreateReduxTextBox -Name "Rupee6" -Length 3 -Text "Silver Rupee"      -Value 5   -Min 1 -Max 500 -Info "Set the amount gained for picking up Silver Rupees."         -Credits "Admentus & Anthrogi (ported)"
}
...
function CreateTabEquipment() {
    ...
    CreateReduxTextBox  -Name "SwordHealth"  -Text "Sword 3 Durability" -Length 3 -Value 8 -Min 1 -Max 255                                -Info "Set the amount of hits the Giant's Knife can take before it breaks." -Credits "Admentus & Anthrogi (ported)" 
    CreateReduxComboBox -Name "ShieldRecoil" -Text "Shield Recoil"      -Default 3 -Items @("None", "Little", "Normal", "Big", "Huge")    -Info "Choose the pushback rate when getting hit while shielding."          -Credits "Admentus (ROM), Aegiker (RAM) & Anthrogi (ported)"
    CreateReduxSlider   -Name "Sword1"       -Text "Sword 1"            -Default 3000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Info "Set the hitbox length of the Kokiri Sword."                          -Credits "Admentus & Anthrogi (ported)"
    CreateReduxSlider   -Name "Sword2"       -Text "Sword 2"            -Default 4000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Info "Set the hitbox length of the Master Sword."                          -Credits "Admentus & Anthrogi (ported)"
    CreateReduxSlider   -Name "Sword3"       -Text "Sword 3"            -Default 5500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Info "Set the hitbox length of the Giant's_Knife/Biggoron_Sword."          -Credits "Admentus & Anthrogi (ported)"
    CreateReduxSlider   -Name "BrokenSword3" -Text "Broken Sword 3"     -Default 1500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Info "Set the hitbox length of the Broken Giant's Knife."                  -Credits "Admentus & Anthrogi (ported)"
    CreateReduxSlider   -Name "Stick"        -Text "Stick"              -Default 5000 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Info "Set the hitbox length of the Deku Stick."                            -Credits "Anthrogi"                     -Warning "Also affects the tip that can be set aflame, use carefully if trying to set it as a torch!"
    CreateReduxSlider   -Name "Hammer"       -Text "Hammer"             -Default 2500 -Min 1024 -Max 9216 -Freq 512 -Small 256 -Large 512 -Info "Set the hitbox length of the Megaton Hammer."                        -Credits "Admentus & Anthrogi (ported)"
...
function CreateTrailColorOptions() {
    ...
    CreateReduxComboBox -Name "AttackTrail"           -Text "Attack Color"       -Default 1 -Items @("White", "Black", "Red", "Green", "Blue", "Yellow", "Cyan", "Magenta", "Gray", "Randomized", "Custom") -Info "Select a preset for the attack trail color."                        -Credits "Rando Team & Anthrogi (ported)"
    $buttons += CreateReduxButton -Tag $Buttons.Count -Text "Trail (Tip)"                                                                                                                                   -Info "Select the tip color you want for the attack trail."                -Credits "Rando Team & Anthrogi (ported)"
    $buttons += CreateReduxButton -Tag $Buttons.Count -Text "Trail (Base)"                                                                                                                                  -Info "Select the base color you want for the attack trail."               -Credits "Rando Team & Anthrogi (ported)"
    ...
    CreateReduxComboBox -Name "Duration1"             -Text "Attack Duration"    -Default 2 -Items @("Disabled", "Default", "Longer", "Longest")                                                            -Info "Select the attack trail duration."                                  -Credits "Rando Team & Anthrogi (ported)"
